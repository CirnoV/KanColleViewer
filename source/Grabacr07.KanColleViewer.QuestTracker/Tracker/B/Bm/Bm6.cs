...
namespace Grabacr07.KanColleViewer.QuestTracker.Models.Tracker
{
	...
	/// 항모기동부대 서쪽으로!
	/// </summary>
	internal class Bm6 : TrackerBase
	{
		...
		public string ProgressText => count >= max_count ? "완료" : "구축2,공모2 포함 함대로 4-2 보스전 S 승리 " + count.ToString() + " / " + max_count.ToString();
