...
namespace Grabacr07.KanColleViewer.QuestTracker.Models.Tracker
{
	...
	/// 제5전대 출격하라!
	/// </summary>
	internal class Bm1 : TrackerBase
	{
		...
		public string ProgressText => count >= max_count ? "완료" : "묘코,나치,하구로 포함 함대로 2-5 보스전 S 승리 " + count.ToString() + " / " + max_count.ToString();
