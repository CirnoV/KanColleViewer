...
namespace Grabacr07.KanColleViewer.PluginAnalyzer {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   {0} の Export 属性が重複しています。과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   {0} の ExportMetadata 属性が重複しています。과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   既に他の プラグイン {0} で使用されている GUID です。과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   GUID の ExportMetadata 属性が不足しています。과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   プラグインを実装するには、プラグイン インターフェイスの実装と、それに対応する Export 属性の指定を行う必要があります。과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   ExportMetadata 属性が不足しています。과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   GUID の ExportMetadata 属性には、GUID と解釈できる形式で、 IPlugin インターフェイスを実装したクラスで指定した GUID と同じ値を指定する必要があります。과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
        ...
        /// <summary>
        ///   プラグインを実装するには、IPlugin インターフェイスを実装したクラスが必要です。과(와) 유사한 지역화된 문자열을 찾습니다.
        /// </summary>
