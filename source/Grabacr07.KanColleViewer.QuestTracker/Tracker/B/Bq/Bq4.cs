...
namespace Grabacr07.KanColleViewer.QuestTracker.Models.Tracker
{
	...
	/// 전선의 항공정찰을 실시하라!
	/// </summary>
	internal class Bq4 : TrackerBase
	{
		...
		public string ProgressText => count >= max_count ? "완료" : "수상기모함 1척, 경순양함 3척 포함한 함대로 6-3 보스전 A승 이상 " + count.ToString() + " / " + max_count.ToString();
