...
namespace Grabacr07.KanColleViewer.QuestTracker.Models.Tracker
{
	...
	/// 수상반격부대 돌입하라!
	/// </summary>
	internal class Bm7 : TrackerBase
	{
		...
		public string ProgressText => count >= max_count ? "완료" : "구축함 기함,구축4,중순1,경순1 함대로 2-5 보스전 S 승리 " + count.ToString() + " / " + max_count.ToString();
